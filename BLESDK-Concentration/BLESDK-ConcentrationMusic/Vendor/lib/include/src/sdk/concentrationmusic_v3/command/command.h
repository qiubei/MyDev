...
#ifndef ALGORITHMSDK_SDK_CONCENTRAION_MUSIC_V3_COMMAND_COMMAND_H
#define ALGORITHMSDK_SDK_CONCENTRAION_MUSIC_V3_COMMAND_COMMAND_H
...
enum INSTRUMENT {
    UNKNOWN = 0, GRAND_PIANO = 1, STRING = 2, VOICE = 3, SOUND = 4
};
...
#endif //NAPTIMEALGORITHM_CONCENTRATIONMUSIC_COMMAND_COMMAND_H
