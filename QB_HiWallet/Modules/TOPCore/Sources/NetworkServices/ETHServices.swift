...
extension ETHServices: TargetType {
    ...
    public var path: String {
        ...
        case .getBalance(address:):
            return "eth/query_balance"
        case .getERC20Balance:
            return "eth/query_erc20_balance"
        case .getNonce:
            return "eth/get_eth_nonce"
        case .sendTransaction:
            return "eth/send_transaction"
        case .getETHTransactionhistory:
            return "eth/get_eth_transaction_list_by_account"
        case .getFeeList:
            return "eth/get_gas_list"
        case .getEthTokenTxHistory:
            return "eth/query_tx_list"
        }
    }
