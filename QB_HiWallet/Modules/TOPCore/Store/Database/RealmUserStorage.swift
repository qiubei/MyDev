...
public class RealmUserStorage: UserStorageServiceInterface {
    ...
    public required init(seedHash: String, password: String) throws {
        ...
        config = Realm.Configuration(fileURL: url, encryptionKey: key, readOnly: false, schemaVersion: DB_Version, migrationBlock: { _, oldSchemaVersion in
            if oldSchemaVersion < DB_Version {
