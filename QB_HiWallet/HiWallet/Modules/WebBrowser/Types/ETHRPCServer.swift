...
//    }
    ...
    var rpcURL: URL {
        let urlString: String = {
            ...
            case .rinkeby: return "https://rinkeby.infura.io/v3/d790204a35ce41dbbab722d01f1a1682"
            }
        }()
...
extension ETHRPCServer: Equatable {
    static func == (lhs: ETHRPCServer, rhs: ETHRPCServer) -> Bool {
        switch (lhs, rhs) {
        case let (lhs, rhs):
